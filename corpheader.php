...
$stage=true;
if (SERVENV!="hon") $consumer_key = "UIRjjejc0733zAX3aOuw"; //stage
else $consumer_key = "J8IsoLp5Y5kShfxp5u5yA"; //hon

// Consumer secretの値
if (SERVENV!="hon") $consumer_secret = "ZkvWkeW6zRH8yu2qXi396qWnUVWZ7syaQdsUVEo4"; //stage
else $consumer_secret = "NaIZr0LAvg1fmROv2qT2bhPle5J0ErdeKOtlgJQGjAs"; //hon
...
else
{
	...
	define ("YAHOO_ID","oXIHz8uxg65do.238Rz2gF0lhxUmz5JHvRnUiSRozfqZXbpXxG6PfMS5AIE7nNZUYx8-");
        ...
        $admin_user_id = "203392851";  // q2dee のuserid

	define ("ADMIN_SCREEN_NAME","q2dee");
	define ("ADMIN_USER_ID","203392851");
