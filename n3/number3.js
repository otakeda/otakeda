...
{
	var t = document.getElementById('info_area');
	t.innerHTML="[game_key]"+game_key;
	t.innerHTML+="[player_key]"+player_key;
	t.innerHTML+="[player_no]"+player_no;
	t.innerHTML+="[set_mode]"+set_mode;
	t.innerHTML+="[answer]"+answer;
	t.innerHTML+="[hit_row]"+hit_row;
	t.innerHTML+="[set_num]"+set_num;
	t.innerHTML+="[COUNTER]"+localStorage.refresh_count;

//	t.innerHTML=navigator.userAgent+"<br />\n";
	if (navigator.geolocation==undefined) t.innerHTML+="Cannot use geo-location";
/*
...
function setAnswer()
{
	...
	var val=document.getElementById(str0+"_1").innerHTML;
	val+=document.getElementById(str0+"_2").innerHTML;
	val+=document.getElementById(str0+"_3").innerHTML;
...
function cancelAnswer()
{
	...
	if (set_mode=='hit')  //下の数字
	{
	document.getElementById("hit_"+player_no+"_"+hit_row+"_1").innerHTML="";
	document.getElementById("hit_"+player_no+"_"+hit_row+"_2").innerHTML="";
	document.getElementById("hit_"+player_no+"_"+hit_row+"_3").innerHTML="";
	}
	if (set_mode=='answer') {  //上の数字
	document.getElementById("answer_"+player_no+"_1").innerHTML="-";
	document.getElementById("answer_"+player_no+"_2").innerHTML="-";
	document.getElementById("answer_"+player_no+"_3").innerHTML="-";
	}
	num3="";
	set_num=1;
	setActive();
...
function resumeNumLinks()
{
	...
	for (i=0;i<10;i++)
	{
	document.getElementById('num_'+i).setAttribute("href","javascript:setNum("+i+");");
	document.getElementById('num_'+i).style.background="";
	}
}
function clearNumLink(nid)
{
	document.getElementById('num_'+nid).style.background=" rgb(100,100, 100)";
	document.getElementById('num_'+nid).setAttribute("href","");
}
function setNum(nid)
{
...
showDebug("setNum:"+curstr);
		document.getElementById(curstr).innerHTML=nid;
...
function entering(uid)
{
	...
	{
		player_key=randnum;
		var str0 =document.getElementById('entry_'+uid);
		str0.innerHTML="Entering...";
		player_no=uid;
		set_num='1';
